class BidProductsController < ApplicationController
  ...
  def new
    @bid_product = BidProduct.new(bid_product_form)
  ...
  def create
    ...
    respond_to do |format|
      if @bid_product.save
        format.html { redirect_to bid_url(@bid_product.bid_id), notice: "İhaleye ürün başarıyla eklendi." }
  ...
  private
    ...
    def bid_product_form
      params.permit(:bid_id, :product_id, :unit_id, :quantity)
    end
end
